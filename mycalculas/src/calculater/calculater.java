...
public class calculater extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jtextDisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jtextDisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  String Enternumber = jtextDisplay.getText() + jButton23.getText();
       jtextDisplay.setText(Enternumber);
    }//GEN-LAST:event_jButton23ActionPerformed

    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
  String Enternumber = jtextDisplay.getText() + jButton22.getText();
       jtextDisplay.setText(Enternumber);
 ...
 String Enternumber = jtextDisplay.getText() + jButton21.getText();
  ...
  String Enternumber = jtextDisplay.getText() + jButton24.getText();
       jtextDisplay.setText(Enternumber);
  ...
  String Enternumber = jtextDisplay.getText() + jButton27.getText();
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
     String Enternumber = jtextDisplay.getText() + jButton31.getText();
       jtextDisplay.setText(Enternumber);
   ...
   String Enternumber = jtextDisplay.getText() + jButton30.getText();
       jtextDisplay.setText(Enternumber);
    ...
    private void jButton33ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton33ActionPerformed
        ...
        jtextDisplay.setText(Double.toString(result));
        
        }
        else if("-".equals(oparations))
        {
        result = firstnum - secondnum;
       // answer = String.format("%.0f",result);
        jtextDisplay.setText(Double.toString(result));
